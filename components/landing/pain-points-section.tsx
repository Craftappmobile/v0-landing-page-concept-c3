...
const painPoints = [
  ...
  },
  {
    ...
    description: "Розумний алгоритм перерахунку адаптує будь-яку схему під ваші індивідуальні параметри в один клік.",
    color: "#E8B54A",
    highlight: "#F5DDA0",
  },
  {
    text: "Забули, що лежить у ваших запасах?",
    description: "Повний контроль ваших запасів та облік вартості.",
    color: "#9B7DB8",
    highlight: "#C9B5DC",
  },
]
