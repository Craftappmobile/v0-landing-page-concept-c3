...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Так, скасувати підписку можна в будь-який момент. Перейдіть до розділу «Профіль» у додатку, знайдіть блок «Статус підписки» та оберіть «Скасувати автопродовження». Підписка залишатиметься активною до кінця вже оплаченого терміну — доступ до всіх функцій збережеться.",
  },
  {
