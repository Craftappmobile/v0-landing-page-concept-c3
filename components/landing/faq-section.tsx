...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Підписка не продовжується автоматично — жодних прихованих списань немає. Після закінчення оплаченого терміну доступ до Premium-функцій припиняється сам по собі, без будь-яких дій з вашого боку. Якщо ви хочете достроково припинити підписку або маєте питання щодо повернення коштів — напишіть нам на craftappmobile@gmail.com.",
  },
  {
  ...
  {
    question: "Як оплатити підписку?",
    answer:
      "Після оплати на вказану пошту надійде лист із посиланням для завантаження додатка, логіном та згенерованим паролем. Увійдіть \u2014 Premium активується автоматично.",
  },
]
