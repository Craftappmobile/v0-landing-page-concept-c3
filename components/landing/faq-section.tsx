...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Підписка продовжується автоматично після закінчення оплаченого терміну. Щоб скасувати автоматичне продовження, напишіть нам на craftappmobile@gmail.com до дати наступного списання — і ми скасуємо підписку без зайвих питань.",
  },
  {
