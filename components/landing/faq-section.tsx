...
const faqItems = [
  ...
  {
    question: "Як скасувати автопродовження підписки?",
    answer:
      "Щоб скасувати автопродовження, перейдіть до розділу «Профіль» у додатку. Знайдіть блок «Статус підписки» та оберіть «Скасувати автопродовження». Підписка залишатиметься активною до кінця вже оплаченого терміну — доступ до всіх функцій збережеться.",
  },
  {
