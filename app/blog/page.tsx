        ...
        <section className="border-b border-border bg-card/40">
          <div className="mx-auto max-w-5xl px-4 py-16 lg:px-8 lg:py-20">
            ...
            <h1 className="mt-4 max-w-3xl text-4xl font-serif leading-tight text-foreground md:text-6xl">
              Статті про в’язання, які легко сканувати й корисно читати
            </h1>
            <p className="mt-5 max-w-2xl text-lg leading-8 text-muted-foreground">
              Один вертикальний список без зайвих плашок: спочатку заголовок, далі короткий опис,
              потім рух униз до наступної статті — природний F-патерн для швидкого вибору теми.
            </p>
          </div>
        </section>
