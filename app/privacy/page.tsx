...
export const metadata: Metadata = {
  ...
  description: "Політика конфіденційності Розрахуй і В'яжи: які дані збираємо, як використовуємо, зберігаємо та захищаємо інформацію користувачів мобільного додатку й вебсайту.",
}
              ...
              <div>
                ...
                <ul className="mt-2 flex flex-col gap-2 pl-5">
                  {[
                    ...
                    "Apple (Sign in with Apple) — авторизація через Apple ID. Apple може отримувати підтвердження автентифікації відповідно до своєї політики конфіденційності.",
