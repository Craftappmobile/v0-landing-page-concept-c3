...
export const metadata: Metadata = {
  ...
  description:
    "Умови повернення коштів за підписку Розрахуй і В'яжи: 14-денне право відмови, процедура заяви, строки повернення та нормативна база.",
}
        ...
        <div className="prose-section mt-10 flex flex-col gap-10">
          ...
          <section>
            ...
            <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
              {"Ці Умови повернення коштів регулюють порядок та умови повернення коштів за підписку на мобільний додаток \u00ABРозрахуй і В'яжи\u00BB (далі \u2014 \u00ABДодаток\u00BB). Придбання підписки здійснюється виключно через офіційний вебсайт розробника."}
            </p>
            <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
          ...
          <section>
            ...
            <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
              {"Щоб скасувати автопродовження підписки, скористайтесь формою на нашому сайті: "}
