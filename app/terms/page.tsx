...
export const metadata: Metadata = {
  ...
  description:
    "Умови використання (Публічна оферта) Розрахуй і В'яжи: правила доступу, підписка, оплата, повернення коштів, автопродовження та відповідальність сторін.",
}
      ...
      <main className="mx-auto max-w-4xl px-4 py-12 lg:px-8 lg:py-16">
        ...
        <div className="prose-section mt-10 flex flex-col gap-10">
          ...
          <section>
            ...
            <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
              {"Підписка продовжується автоматично після закінчення оплаченого терміну шляхом рекурентного списання з картки."}
            </p>

            <h3 className="mt-4 text-base font-semibold text-foreground">
              {"4.3. Скасування автопродовження"}
            </h3>
            <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
