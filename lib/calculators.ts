...
const seoCalculatorPages: CalculatorDefinition[] = [
  createSeoCalculator({ slug: "horlovyna", shortTitle: "Калькулятор горловини", topic: "розрахунок горловини", formula: "Петлі горловини = обхват горловини × петлі в 1 см", example: "Якщо обхват горловини 42 см, а щільність 2,2 п/см, потрібно близько 92 петель. Далі петлі розподіляють на перед, спинку й плечові ділянки.", checklist: ["Виміряйте бажаний обхват горловини.", "Переведіть мірку в петлі через щільність.", "Перевірте кратність гумки або планки."], keywords: ["калькулятор горловини", "розрахунок горловини", "петлі горловини"], relatedCalculatorSlug: "shchilnist", relatedCalculatorLabel: "Калькулятор щільності", relatedPosts: ["yak-rozrahuvaty-dzhemper-z-kruhlym-vyrizom", "yak-rozrahuvaty-horlovynu-svetra", "yak-rozrahuvaty-v-podibnyy-vyriz"] }),
  ...
  createSeoCalculator({ slug: "humka", shortTitle: "Калькулятор гумки", topic: "розрахунок гумки", formula: "Петлі гумки = потрібна ширина × щільність гумки з урахуванням розтягу", example: "Для манжети 20 см і гумки 2×2 з щільністю 2,4 п/см потрібно 48 петель, що вже кратно 4.", checklist: ["Міряйте щільність саме в гумці.", "Перевіряйте кратність 1×1, 2×2 або 3×3.", "Враховуйте еластичність і посадку."], keywords: ["калькулятор гумки", "гумка 2х2", "розрахунок гумки"], relatedCalculatorSlug: "shchilnist", relatedCalculatorLabel: "Калькулятор щільності", relatedPosts: ["yak-rozrahuvaty-humku-dlya-svetra", "yak-rozrahuvaty-horlovynu-svetra", "yak-rozrahuvaty-shchilnist-vyazannya"] }),
  createSeoCalculator({ slug: "kruhove", shortTitle: "Калькулятор кругового вʼязання", topic: "кругове в'язання без швів", formula: "Петлі = обхват виробу × щільність", example: "Шапка 54 см при 2,1 п/см: 113 п, краще округлити до 112 або 116 залежно від маківки.", checklist: ["Зніміть мірку по колу.", "Врахуйте розтяг полотна.", "Перевірте кратність убавок."], keywords: ["кругове в'язання", "калькулятор кругового в'язання", "петлі по колу", "кругове вязання", "калькулятор по колу", "в'язання без швів"], relatedCalculatorSlug: "shapka", relatedCalculatorLabel: "Калькулятор шапки", relatedPosts: ["yak-rozrahuvaty-krugove-vyazannya", "yak-rozrahuvaty-petli-dlya-shapky", "yak-rozrahuvaty-shchilnist-vyazannya"] }),
  createSeoCalculator({ slug: "letucha-mysha", shortTitle: "Калькулятор рукава летюча миша", topic: "розрахунок летючої миші", formula: "Ширина полотна = півобхват корпусу + довжина рукава", example: "Півобхват 52 см і рукав 38 см дають 90 см ширини деталі перед перерахунком у петлі.", checklist: ["Визначте бажану ширину від центру до манжети.", "Перевірте драпірування полотна.", "Не робіть манжету занадто широкою."], keywords: ["летюча миша спицями", "калькулятор рукава летюча миша", "розрахунок летюча миша"], relatedCalculatorSlug: "rukav", relatedCalculatorLabel: "Калькулятор рукава", relatedPosts: ["yak-rozrahuvaty-rukav-letucha-mysha", "yak-rozrahuvaty-rukav-svetra", "yak-rozrahuvaty-shchilnist-vyazannya"] }),
  createSeoCalculator({ slug: "mokher", shortTitle: "Калькулятор мохеру", topic: "розрахунок мохеру", formula: "Вага = потрібний метраж / метраж у 100 г × 100", example: "Якщо потрібно 900 м, а мохер має 420 м/50 г, це 840 м/100 г: 900 / 840 × 100 ≈ 107 г.", checklist: ["Переведіть етикетку в м/100 г.", "Додайте запас на пух і зразок.", "Для подвійної нитки перерахуйте метраж складання."], keywords: ["калькулятор мохеру", "мохер витрата", "розрахунок мохеру"], relatedCalculatorSlug: "skladannya", relatedCalculatorLabel: "Калькулятор складання пряжі", relatedPosts: ["yak-rozrahuvaty-vyazannya-z-mokheru", "yak-rozrahuvaty-vytratu-pryazhi-na-svetr", "yak-rozrahuvaty-shchilnist-vyazannya"] }),
