...
const PLAN_DETAILS = {
  quarter: {
    ...
    renewalNotice: "Наступний платіж через 3 місяці — 454,96 грн.",
  ...
  half: {
    ...
    renewalNotice: "Наступний платіж через 6 місяців — 600,00 грн.",
  ...
  year: {
    ...
    renewalNotice: "Наступний платіж через 1 рік — 918,00 грн.",
  ...
  forever: {
    ...
    priceValue: "2 499,00",
    priceWithCurrency: "2 499,00 грн",
